...
/**
 * @brief sets mcp23017/mcp23008 port mode for each pin
 * @param i2c_port i2c port (0..9)
 * @param adr i2c address (ADR_..)
 * @param port_adr selects port (PORT_A ..)
 * @param mode mode values (INPUT..) as array
 * @returns true: ok, false: error
 *
 * @note INT pin is set to open-drain (set on active to low)
 * @note resets also interrupt
 *
 * @note if port_adr = PORT_A mode is array where index 0=GPA0..7=GPA7
 * @note if port_adr = PORT_B mode is array where index 0=GPB0..7=GPB7
 * @note if port_adr = PORT_AB mode is array where index 0=GPA0..7=GPA7, 8=GPB0 15=GPB7
 * @note if port_adr = PORT_8 mode is array where index 0=GP0..7=GP7 (mcp23008)
 */
bool set_mode(uint8_t i2c_port, uint8_t adr, uint8_t port_adr, vector<uint8_t>& mode);

/**
 * @brief sets mcp23017/mcp23008 port mode for all pins
 * @param i2c_port i2c port (0..9)
 * @param adr i2c address (ADR_..)
 * @param port_adr selects port (PORT_A ..)
...
/**
 * @brief sets mcp23017/mcp23008 interrupt mode for each pin
 * @param i2c_port i2c port (0..9)
 * @param adr i2c address (ADR_..)
 * @param port_adr selects port (PORT_A ..)
 * @param mode interrupt mode values (INT_OFF, INT_ON) as array
 * @returns true: ok, false: error
 *
 * @note INT pin is set to open-drain (set on active to low)
 * @note resets also interrupt
 ...
 * @note if port_adr = PORT_8 mode is array where index 0=GP0..7=GP7 (mcp23008)
 */
bool set_interrupt_mode(uint8_t i2c_port, uint8_t adr, uint8_t port_adr, vector<uint8_t>& mode);

/**
 * @brief sets mcp23017/mcp23008 interrupt mode for all pins
 * @param i2c_port i2c port (0..9)
 * @param adr i2c address (ADR_..)
 * @param port_adr selects port (PORT_A ..)
...
/**
 * @brief reads mcp23017/mcp23008 interrupt state and returns array
 * @param i2c_port i2c port (0..9)
 * @param adr i2c address (ADR_..)
 * @param port_adr selects port (PORT_A ..)
 ...
 *
 * @note if port_adr = PORT_A int_state is array where index 0=GPA0..7=GPA7
 * @note if port_adr = PORT_B int_state is array where index 0=GPB0..7=GPB7
 * @note if port_adr = PORT_AB int_state is array where index 0=GPA0..7=GPA7, 8=GPB0 15=GPB7
 * @note if port_adr = PORT_8 int_state is array where index 0=GP0..7=GP7 (mcp23008)
 */
bool get_interrupt_state(uint8_t i2c_port, uint8_t adr, uint8_t port_adr, vector<uint8_t>& int_state);

/**
 * @brief reads mcp23017/mcp23008 interrupt state and returns number
 * @param i2c_port i2c port (0..9)
 * @param adr i2c address (ADR_..)
 * @param port_adr selects port (PORT_A ..)
 ...
 *
 * @note if port_adr = PORT_A int_state is bit0=GPA0..bit7=GPA7
 * @note if port_adr = PORT_B int_state is bit0=GPB0..bit7=GPB7
 * @note if port_adr = PORT_AB int_state is bit0=GPA0..bit7=GPA7, bit8=GPB0..bit15=GPB7
 * @note if port_adr = PORT_8 int_state is bit0=GP0..bit7=GP7 (mcp23008)
 */
bool get_interrupt_state(uint8_t i2c_port, uint8_t adr, uint8_t port_adr, uint16_t& int_state);

/**
 * @brief reads mcp23017/mcp23008 port and returns array
 * @param i2c_port i2c port (0..9)
 * @param adr i2c address (ADR_..)
 * @param port_adr selects port (PORT_A ..)
 ...
 * @note resets also interrupt
 *
 * @note if port_adr = PORT_A port_data is array where index 0=GPA0..7=GPA7
 * @note if port_adr = PORT_B port_data is array where index 0=GPB0..7=GPB7
 * @note if port_adr = PORT_AB port_data is array where index 0=GPA0..7=GPA7, 8=GPB0 15=GPB7
 * @note if port_adr = PORT_8 port_data is array where index 0=GP0..7=GP7 (mcp23008)
 */
bool read_port(uint8_t i2c_port, uint8_t adr, uint8_t port_adr, vector<uint8_t>& port_data);

/**
 * @brief reads mcp23017/mcp23008 port and returns number
 * @param i2c_port i2c port (0..9)
 * @param adr i2c address (ADR_..)
 * @param port_adr selects port (PORT_A ..)
...
/**
 * @brief writes to mcp23017/mcp23008 port from array
 * @param i2c_port i2c port (0..9)
 * @param adr i2c address (ADR_..)
 * @param port_adr selects port (PORT_A ..)
 * @param port_data port values as array
...
/**
 * @brief writes to mcp23017/mcp23008 port from number
 * @param i2c_port i2c port (0..9)
 * @param adr i2c address (ADR_..)
 * @param port_adr selects port (PORT_A ..)
 * @param port_data port values as number
